                ...
                with st.container():
                    ...
                    with col4:
                        if gender:
                            pass
                with st.container():
                    if (get_title(data3, CAT3).split(":")[1].split("-")[0].strip() == "negative") and (get_title(pred, CAT6).split(":")[1].split("-")[0].strip() == "angry") and ((get_title(pred_, CAT7).split(":")[1].split("-")[0].strip()) == "disgust") or ((get_title(pred_, CAT7).split(":")[1].split("-")[0].strip()) == "fear") :
