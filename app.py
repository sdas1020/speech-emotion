        ...
        with st.container():
            ...
            with col2:
                if audio_file is not None:
                    ...
                    # st.write(fig)
                    image = Image.open('images/child.jpg')
                ...
                with st.container():
                    ...
                    with col4:
                        if gender:
                            pass
                with st.container():
                    if (get_title(data3, CAT3).split(":")[1].split("-")[0].strip() == "negative") and (get_title(pred, CAT6).split(":")[1].split("-")[0].strip() == "angry") and ((get_title(pred_, CAT7).split(":")[1].split("-")[0].strip()) == "disgust") and ((get_title(pred_, CAT7).split(":")[1].split("-")[0].strip()) == "fear") :
